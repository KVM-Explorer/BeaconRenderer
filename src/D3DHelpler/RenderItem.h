...
public:
    ...
    RenderItem &SetConstantInfo(uint index, D3D12_GPU_VIRTUAL_ADDRESS base, uint elementSize, uint rootParameterIndex);

    void DrawItem(ID3D12GraphicsCommandList *commandList);
